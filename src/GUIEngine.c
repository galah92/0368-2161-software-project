...
Pane* SettingsPane_Create(SDL_Renderer *renderer) {
    Button *buttons[] = {
        ...
        Button_Create(renderer,
                      SRC_BUTTON_1_PLAYER,
                      (SDL_Rect){ .x = 25, .y = 80, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderGameMode1Button,
                      onClickGameMode1Button),
        Button_Create(renderer,
                      SRC_BUTTON_2_PLAYER,
                      (SDL_Rect){ .x = 135, .y = 80, .w = BUTTON_W_S, .h = BUTTON_H },
        ...
        Button_Create(renderer,
                      SRC_BUTTON_AMATEUR,
                      (SDL_Rect){ .x = 25, .y = 205, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderDifficulty1Button,
                      onClickDifficulty1Button),
        Button_Create(renderer,
                      SRC_BUTTON_EASY,
                      (SDL_Rect){ .x = 135, .y = 205, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderDifficulty2Button,
                      onClickDifficulty2Button),
        Button_Create(renderer,
                      SRC_BUTTON_MODERATE,
                      (SDL_Rect){ .x = 25, .y = 260, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderDifficulty3Button,
                      onClickDifficulty3Button),
        Button_Create(renderer,
                      SRC_BUTTON_HARD,
                      (SDL_Rect){ .x = 135, .y = 260, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderDifficulty4Button,
                      onClickDifficulty4Button),
        Button_Create(renderer,
                      SRC_BUTTON_EXPERT,
                      (SDL_Rect){ .x = 80, .y = 315, .w = BUTTON_W_S, .h = BUTTON_H },
        ...
        Button_Create(renderer,
                      ...
                      (SDL_Rect){ .x = 25, .y = 440, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderUserColorWhiteButton,
                      onClickUserColorWhiteButton),
        Button_Create(renderer,
                      SRC_BUTTON_USER_COLOR_BLACK,
                      (SDL_Rect){ .x = 135, .y = 440, .w = BUTTON_W_S, .h = BUTTON_H },
...
Pane* LoadPane_Create(SDL_Renderer *renderer) {
    Button *buttons[] = {
        ...
        Button_Create(renderer,
                      SRC_BUTTON_SLOT3,
                      (SDL_Rect){ .x = 25, .y = 135, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderSlot3Button,
                      onClickSlot3Button),
        Button_Create(renderer,
                      SRC_BUTTON_SLOT4,
                      (SDL_Rect){ .x = 135, .y = 135, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderSlot4Button,
                      onClickSlot4Button),
        Button_Create(renderer,
                      SRC_BUTTON_SLOT5,
                      (SDL_Rect){ .x = 80, .y = 190, .w = BUTTON_W_S, .h = BUTTON_H },
                      onPreRenderSlot5Button,
                      onClickSlot5Button),
        Button_Create(renderer,
                      SRC_BUTTON_LOAD,
                      (SDL_Rect){ .x = 25, .y = 260, .w = BUTTON_W, .h = BUTTON_H },
                      NULL,
                      onClickLoadButton),
        Button_Create(renderer,
                      SRC_BUTTON_SAVE,
